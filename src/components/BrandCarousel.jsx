    ...
    <div className="py-6 border-y border-obsidian-border bg-obsidian-dark/60 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-[11px] font-mono text-paper-muted uppercase tracking-widest mb-4">
          AUTHORIZED INSTALLER & CERTIFIED PARTNER FOR LEADING BRANDS
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 items-center">
          {brands.map((b, idx) => (
            <div 
              key={idx} 
              className="p-3 rounded-xl bg-obsidian-card/70 border border-obsidian-border text-center hover:border-copper/40 transition-colors"
            >
